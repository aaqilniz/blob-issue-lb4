...
const config = {
  ...
  skipLocalCache: true,
  _: [],
  c: '{"name":"localsource","connector":"mysql","url":"","host":"localhost","port":"3306","user":"root","password":"asdf","database":"track"}',
  y: true,
  ...
  'force-install': false,
  'ask-answered': false,
  config: '{"name":"localsource","connector":"mysql","url":"","host":"localhost","port":"3306","user":"root","password":"asdf","database":"track"}',
  yes: true,
  url: '',
  host: 'localhost',
  port: 3306,
